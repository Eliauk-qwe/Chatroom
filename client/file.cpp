#include "client.hpp"
void send_file(string uid,string friend_or_group,StickyPacket f_socket,int flag){
    string filepath;
...
void recv_file(string uid,string friend_or_group,StickyPacket f_socket,int flag){
    printf("你要下载的文件名为：\n");
    string filename;
    ...
    Message msg(uid,friend_or_group,{filename},flag);
    f_socket.mysend(msg.S_to_json());
